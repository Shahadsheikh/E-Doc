                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                <td width="30%" style="padding-left:20px" >
                                    <img src="../img/user1.webp" alt="" width="100%" style="border-radius:50%">
                                </td>
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items" style="padding:20px; margin:auto; width:95%; display:flex">
                                        <div>
                                                ...
                                                <div class="btn-icon-back dashboard-icons" style="margin-left: auto;background-image: url('../img/icons/doctors-hover.svg');"></div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;text-align:left;padding-left:48px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
